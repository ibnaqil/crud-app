...
<div id="app">
    <nav class="bg-white border-gray-200 dark:bg-gray-900 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <a href="{{ url('/') }}" class="flex items-center">
                <div class="flex justify-center">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg"
                         class="h-8 mr-3 w-auto bg-gray-100 dark:bg-gray-900">
                        <path
            ...
            <button id="dropdownNavbarLink" data-collapse-toggle="navbar-dropdown" type="button"
            ...
            <div class="hidden w-full md:block md:w-auto" id="dropdownNavbar">
                <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('home') }}"
                               class="{{ Route::currentRouteName() === 'home' ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent' : ''}}
                        ...
                        <li>
                            <a href="{{ route('opd') }}"
                               class="{{ Route::currentRouteName() === 'opd' ? 'text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent' : ''}} block
                               py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent
                               md:border-0 md:hover:text-blue-700 md:p-0 dark:text-white md:dark:hover:text-blue-500
                               dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
                               aria-current="page">OPD</a>
                        </li>
                        <li>
                            <button id="dropdownProfileLink" data-dropdown-toggle="dropdownNavbar"
                            ...
                            <div id="dropdownProfile"
                                 class="z-10 absolute hidden font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
...
<script>
    ...
    // Grab HTML Elements
    const btn = document.querySelector("#dropdownProfileLink");
    const menu = document.querySelector("#dropdownProfile");
